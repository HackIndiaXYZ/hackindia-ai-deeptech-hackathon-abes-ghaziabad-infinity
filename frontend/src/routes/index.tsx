  ...
  useEffect(() => {
    ...
    const arcs = ARC_PAIRS.map(([i, j]) => {
      ...
      const mid = new THREE.Vector3()
        ...
        .multiplyScalar(0.5)
        .normalize()
        .multiplyScalar(1.35 + a.pos.distanceTo(b.pos) * 0.22);
      ...
      >
        {isAlerts ? (
          <>
            ...
            {[
              ...
              >
                ...
                <div style={{ color: a.col, fontSize: 10, fontWeight: 700, marginTop: 3 }}>
                  {a.sev}
                </div>
              </div>
            ))}
          ...
          <>
            ...
            >
              <Globe size={28} style={{ color: C.primary, opacity: 0.7 }} />
            </div>
            <div style={{ color: "#CBD5E1", fontSize: 11, fontWeight: 600, marginBottom: 8 }}>
              Top Locations
            </div>
            {[
              ["United States", "5.2K"],
...
function SentivoyLanding() {
  ...
  useEffect(() => {
    const id = setInterval(() => setLiveCount((n) => n + Math.floor(Math.random() * 40 + 5)), 1400);
  ...
  const features = [
    {
      ...
      desc: "Ingest logs from hundreds of sources simultaneously with sub-second latency and zero data loss.",
    },
    {
      icon: <Cpu size={22} />,
      title: "AI anomaly detection",
      desc: "Detect unusual behaviour using advanced ML models trained on billions of security events.",
    },
    {
      icon: <Globe size={22} />,
      title: "Global threat intelligence",
      desc: "Correlate events with global threat feeds for smarter, faster contextual analysis.",
    },
    {
      icon: <Zap size={22} />,
      title: "Agentic response system",
      desc: "Autonomous decision-making that prioritises and recommends actions in real time.",
    },
    {
      icon: <BarChart2 size={22} />,
      title: "Interactive dashboards",
      desc: "Visualise trends, threats, and insights with intuitive drag-and-drop dashboards.",
    },
    {
      icon: <Lock size={22} />,
      title: "Secure & scalable",
      desc: "Enterprise-grade infrastructure built to handle petabyte-scale log volumes with SOC 2 compliance.",
    },
  ];
  ...
  const testimonials = [
    {
      quote:
        "Sentivoy transformed how we detect and respond to threats. It's like having an elite security analyst on call 24/7.",
      name: "Arjun Mehta",
      role: "CTO, NetSecure",
      initials: "AM",
      color: C.primary,
    ...
    {
      quote:
        "The AI-driven insights helped us slash incident response time by 60%. Onboarding took less than a day.",
      name: "Priya Nair",
      role: "Head of Security, Cloudlytics",
      initials: "PN",
      color: "#7B5CE4",
    },
    {
      quote:
        "Easy to deploy, insanely powerful AI engine, and the support team is exceptional. Worth every dollar.",
      name: "David Lee",
      role: "Security Engineer, FinEdge",
      initials: "DL",
      color: C.orange,
    },
  ];
    ...
    >
      ...
      >
        ...
        >
          ...
          <div style={{ flex: 1, minWidth: 0, animation: "fadeUp .7s ease both" }}>
            ...
            >
              Sentivoy monitors, detects, and responds to threats in real time using AI and
              behavioural analytics — so your team can act before damage is done.
            </p>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              ...
              <div>
                <div style={{ fontSize: 13, fontWeight: 700, color: C.navy }}>
                  Trusted by <span style={{ color: C.primary }}>2,500+</span> security teams
                </div>
          ...
          >
            ...
            >
              ...
              <div
                style={{ fontSize: 18, fontWeight: 800, color: C.navy, letterSpacing: "-.02em" }}
              >
      ...
      >
        ...
        >
          ...
          {["NetSecure", "Cloudlytics", "FinEdge", "ArcShield", "VaultAI"].map((c) => (
            <span
              key={c}
              style={{ fontSize: 16, fontWeight: 800, color: "#CBD5E1", letterSpacing: "-.02em" }}
            >
              {c}
            </span>
          ))}
      ...
      <section id="features" style={{ padding: "96px 24px" }}>
        <div style={{ maxWidth: 1160, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 56 }}>
            ...
            >
              Everything you need to monitor, detect, and respond — in one intelligent, integrated
              platform.
            </p>
          </div>
          ...
          >
            ...
            <div style={{ flex: "0 0 320px", minWidth: 0 }}>
              ...
              <p style={{ fontSize: 15, color: C.textMuted, lineHeight: 1.65, marginBottom: 28 }}>
                Sentivoy gives you full context into every event with behavioural insights and AI
                risk scoring — so you always know where to focus.
              </p>
      ...
      <section style={{ padding: "96px 24px", background: "#fff" }}>
        ...
        >
          ...
          <div style={{ flex: "0 0 340px", minWidth: 0 }}>
            ...
            <p style={{ fontSize: 15, color: C.textMuted, lineHeight: 1.65, marginBottom: 28 }}>
              Stay informed and respond faster with real-time alerts and AI insights available on
              iOS and Android — wherever your team is.
            </p>
        ...
        <div style={{ maxWidth: 860, margin: "0 auto" }}>
          ...
          >
            ...
            <div style={{ display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap" }}>
              <button onClick={() => navigate({ to: "/auth" })} className="btn-white">
                Start Free Trial
              </button>
      ...
      <footer style={{ background: C.navy, padding: "64px 24px 32px" }}>
        <div style={{ maxWidth: 1160, margin: "0 auto" }}>
          ...
          >
            ...
            <div>
              ...
              <div style={{ display: "flex", gap: 14, marginTop: 20 }}>
                {[<Twitter size={16} />, <Linkedin size={16} />, <Github size={16} />].map(
                  (ic, i) => (
                    <a
                      key={i}
                      href="#"
          ...
          >
            <p style={{ color: "#475569", fontSize: 13 }}>© 2024 Sentivoy. All rights reserved.</p>
