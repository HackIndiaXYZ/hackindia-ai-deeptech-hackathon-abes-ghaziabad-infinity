...
export const AuthPanel = () => {
  ...
  const handleOAuth = async (provider: "google" | "github") => {
    try {
      ...
      setError(getErrorMessage(error, `An error occurred while logging in with ${provider}.`));
    }
  };
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-black/80 overflow-hidden">
      ...
      >
        <source
          src="https://assets.mixkit.co/videos/preview/mixkit-abstract-technology-network-connections-loop-27411-large.mp4"
          type="video/mp4"
        />
      </video>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-400 mt-2 text-sm">
              {isLogin
                ...
                : "Join us to secure your infrastructure"}
            </p>
          </div>
